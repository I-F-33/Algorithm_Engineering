...
def create_employee_list():
    employee_list = []
    n = int(input("Enter the # of Employees: "))
    for i in range(n):
...
def sort_and_display_employee(employee_list):
    while True:
        ...
        if choice == '1':
            ...
            print("Thank you, we are exiting the program")
            break
        else:
...
def main():
    ...
    sort_and_display_employee(employee_list)
